...
return [
    ...
    */
     ...
     */
    'constants' => [
        'L5_SWAGGER_CONST_HOST_V1' => env('APP_URL') . '/api/v1',
        'L5_SWAGGER_CONST_TITLE' => env('APP_NAME'),
        'L5_SWAGGER_CONST_DESCRIPTION' => env('APP_DESCRIPTION'),
        'L5_SWAGGER_DOCS_VERSION' => env('SWAGGER_DOCS_VERSION'),
        'L5_SWAGGER_API_SCHEMES' => env('SWAGGER_API_SCHEMES')
    ],
];
